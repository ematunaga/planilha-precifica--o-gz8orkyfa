...
Deno.serve(async (req: Request) => {
  ...
  try {
    ...
    const platformUrl = origin || req.headers.get('origin') || 'https://leapit-precificacao.goskip.app';
    ...
    console.log(`[SIMULATED EMAIL] Body: Você foi convidado para participar como ${role}. Acesse para registrar sua conta: ${platformUrl}/register?token=${token}`);
